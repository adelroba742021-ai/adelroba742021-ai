...
## مدير مكتبة الكتب 📚:
هذا مشروع بسيط يساعد المستخدمين على إدارة مجموعة الكتب الخاصة بهم وقائمة الكتب التي يرغبون في اقتنائها مستقبلًا.
...
## مولد كلمات المرور🔐:
هذا برنامج  يقوم بإنشاء كلمة مرور عشوائية بناءً على تفضيلات المستخ
...
## لعبه خمن الكلمة :
هذا المشروع عبارة عن لعبة تخمين كلمات .
يقوم اللاعب بتخمين حروف الكلمة المخفية حرفًا حرفًا، وإذا كان التخمين صحيحًا يظهر الحرف في مكانه الصحيح، أما إذا كان التخمين خاطئًا يخسر اللاعب محاولة وتظهر مرحلة جديدة من رسمة الرجل المشنوق.
تستمر اللعبة حتى يتم تخمين الكلمة كاملة أو تنتهي جميع المحاولات.
